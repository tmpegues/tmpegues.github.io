...
## Overview
This robot was built in a team of four for Caltech's {% include elements/ext_link.html link="https://www.cms.caltech.edu/academics/courses/mecsee-134" text="ME/EE/CS 134: Robotic Systems "%}.
...
Unfortunately, I don't have the full documentation for this project anymore, but I do have the vision code: {% include elements/button.html link="https://github.com/tmpegues/jenga_vision" text="GitHub" style="secondary" size="sm" %}
