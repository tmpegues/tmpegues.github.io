...
{% include elements/video.html id="https://tmpegues.github.io/assets/bug/overview_mute.mp4" caption="The FER arm picking up a turtle/HexBug" %}
...
The video below shows the robot sorting out the turtles based on user input.
{% include elements/video.html id="https://tmpegues.github.io/assets/bug/sort.mp4" %}

The video below shows the computer-view of the bug and robot locations.
